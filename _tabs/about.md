...
Recently, I've fallen into the world of hardware 'hacking' and the weird, wonderful, and wacky world of IoT devices. 
This has led me to learning the art of not burning yourself whilst soldering UART pins, as well as chasing the dragon (disassembling firmware in Ghidra).
...
### Current projects: 
- **CPTS Exam - [Penetration Testing Certification](https://academy.hackthebox.com/preview/certifications/htb-certified-penetration-testing-specialist)**
  - Currently preparing for this exam by completing a bunch of HTB boxes and creating write-ups to reinforce my knowledge.
- **TL-WR841N Writeup**
  - Tear**-**down and analysis of the TP-Link TL-WR841N router. Performed in conjunction with my completion of the [IoT Hacking Course](https://academy.tcm-sec.com/p/beginner-s-guide-to-iot-and-hardware-hacking) by TCM. 
- **Tapo C110 Research**
...
[email](mailto:alex.mazza@outlook.com) or find me on [LinkedIn](https://www.linkedin.com/in/almazza/).
